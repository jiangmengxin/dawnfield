...
晨露之野 Dawnfield 是 Phaser 4.1 + Vite 7 + TypeScript 5.8 的吸血鬼幸存者类网页游戏。从约 4.5K 行的垂直切片（1 角色、7 武器各带进化、6 被动、9 敌人、1 张无限地图、12 分钟单局、1 个 Boss）扩展为「角色/武器/地图/文案全原创」的大体量 1.0：
